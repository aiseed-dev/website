...
そして、ゴミの多い GitHub を学習データに選んだ決定の責任者は、Microsoft
の CEO、**サティア・ナデラ**だ。GitHub を買収し、OpenAI に賭けたのは
彼であり、その土台の上で、公開 GitHub のコードが Copilot の学習データ
になった。**何で学習させるかは、経営判断だ**。その判断が、出力の質に
出ている。
