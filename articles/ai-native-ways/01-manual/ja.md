...
このコツの構造的な深掘り ── 「自律エージェントを動かすな」「AI はサンドボックスで使う」「Office に AI を統合する道は最も安易で最も危険」 ── は、本シリーズ [第 11 章「AIに任せる仕事を見極める」](/ai-native-ways/ai-delegation/) で扱います。
...
ハルシネーションへの対処と、AI が乗りやすい「物語」（Microsoft 発の AGI 寓話など）を見抜く実務的な手順は、本シリーズ [第 12 章「AIで物語を検証する」](/ai-native-ways/verify-narratives/) で扱います。
...
- [第2章 ── 処理を書く ── AIにPythonで書いてもらう](/ai-native-ways/python/) ── コツ 2・5 の道具立て編
- [第11章 ── AIに任せる仕事を見極める](/ai-native-ways/ai-delegation/) ── コツ 3 の構造的な深掘り
- [第12章 ── AIで物語を検証する](/ai-native-ways/verify-narratives/) ── コツ 5 の検証編
- [第13章 ── 1人+AIで作る、新しい仕事の単位](/ai-native-ways/one-plus-ai/) ── コツ 6 の到達点
