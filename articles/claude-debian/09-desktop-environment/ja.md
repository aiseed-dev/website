...
「GNOME / KDE じゃないと作業できない」という人は、たいてい **作業の中身が
DE 依存になっている**(画面の見た目に依存する仕事をしている)。

本書の立場では、**Zed / Neovim を中心に置き、ブラウザ + ターミナルで
1 日が回る**なら、DE は最小で十分。第 13 章のエディタ三選(Zed / Neovim /
