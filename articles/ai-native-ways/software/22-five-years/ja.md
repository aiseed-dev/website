...
- **SIer 委託モデルが構造的に不経済** (3-02) ── 同じ手間で自分で
  作れる
- **価格差が桁違い** (3-03) ── 10倍〜100倍、競争ではなく市場破壊
- **ロックインが解消する** (3-04) ── AI ネイティブな標準コード、
  Palantir FDE の対極
- **各社がビルダーを雇用する** (3-05) ── 弁護士・医師と同位置の
...
4. **判断中心の専門職は本質的に独立志向** ── 弁護士・医師・会計士
   が個人事務所やパートナーシップを好むのは偶然ではない(3-05)
...
(3-02)、顧客が自分で作る(1-05)、判断中心のビルダー(1-04・3-05)、
...
| 自由都市・ギルド | フィレンツェ、ヴェネツィア、職人組合 | AI 時代の自由人、専門職組合(3-05) |
...
規模(1-04)、弁護士・医師(3-05)と同じ位置。中規模のアプリ
