...
自動運転、ロボットなど) には拡張できない (この境界線は3-08で扱う)。
...
- 3-04 ── 価格構造が違う相手と競争すると、どれだけの差になるか
- 3-05 ── 既存の委託関係は、どこで**ロックイン**として機能するか
- 3-06〜3-08 ── ビルダーの雇用、SIer 業界の転換、転換が近い将来に
  起き、もう戻らないこと
...
- [3-08: もう戻らない構造転換](/ai-native-ways/software/five-years/)
