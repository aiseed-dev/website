...
これが、先ほどの「vibe coding」だ ── 旧来の「コードさえ書ければいい」
が、AI で加速したものにすぎない。AI が文脈を理解できると言っても、
**渡す文脈が曖昧なら、理解しようがない**。AI が速いほど、文脈を明示に
していない開発の負債は、速く積み上がる。**一次資料を、コードから
設計・仕様・文脈へ移す** ── それが、vibe coding を防ぐ鍵だ。
