...
> 同じ「ベンダー集中」の話だ(自立編 第5章)。中身は同じだが、データの
...
> に置く**。これが自立編 第5章「自分のシステムを自分の側に置く」の Git
> 版だ。
...
Microsoft Office と OnlyOffice の関係(自立編 第5章)と同じ構造だ ──
...
コードと業務文書が **自分たちのもの** になる(自立編 第5章の Office 議論
と同じ構造)。これも実体は **セルフホスト**。
