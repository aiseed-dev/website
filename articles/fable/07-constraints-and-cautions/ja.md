...
description: Fable 5 には安全分類器があり、特定分野の依頼はブロックされて Opus 4.8 が代わりに応答する。利用上限と料金体系は移行中、通信は原則30日間保持される。3つの制約を整理し、「その仕事は Fable 5 に頼む価値があるか?」のチェックリストで連載を締めくくる。連載「Fable 5 が帰ってきた」第7回(最終回)。
date: 2026.07.02
lang: ja
prev_slug: office-core-oss
prev_title: Office スイートと業務システムを開く ── OSS につなぎ直す
