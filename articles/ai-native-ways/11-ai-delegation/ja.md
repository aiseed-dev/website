...
[第 1 章「活用マニュアル」のコツ 3](/ai-native-ways/manual/)（**処理は AI に、責任は自分に**）を、この章では「組織として AI を運用する」レベルに引き上げて扱う。
...
これは章 02〜10 で積み上げてきた **AI ネイティブな道具立て** そのものだ。
...
共通するのは ──
**「収集・整理・下書き・候補出し」は AI に、「対話・判断・責任」
は人間に**。

そして、AI に渡したものの結果は **きちんと自分で読んで確認** する
(序章「信頼して頼む + 結果はきちんとチェック」)。AI が出した
ファクトは仮説、自分で原典に当たって裏取りする(第11章「物語を
検証する」)。
...
- [第10章: 組み込みを作る ── Pythonで考え、Claudeに翻訳させる](/ai-native-ways/embedded/)
