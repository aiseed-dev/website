...
title: 2027年、日本ではリン酸肥料は手に入らなくなる——もう自然農法でやるしかない
subtitle: 中国輸出停止、モロッコの硫黄トラップ、汚泥PFAS汚染——供給の9割が失われる構造
description: 2026年秋作で肥料在庫が尽き、2027年にはリン酸肥料が事実上入手できなくなる。中国の輸出停止、モロッコの硫黄トラップ、半導体・EVとの硫酸争奪戦、下水汚泥回収のPFAS汚染問題——全てを踏まえると、自然農法への転換は理念ではなく物理的必然になる。
date: 2026.04.23
label: Blog
category: 構造分析ノート
---
...
:::compare
| 調達ソース | 現実の平時依存度 | 2027年確保率 | 実効寄与度 |
| --- | --- | --- | --- |
| 輸入(中国) | 50.0% | 0.0% | 0.0% |
| 輸入(モロッコ等) | 40.0% | 21.0% | 8.4% |
| 輸入(米・露・他) | 8.0% | 15.0% | 1.2% |
| 国内回収(汚泥等) | 2.0% | 120.0% | 2.4% |
| **総計** | **100.0%** | **—** | **約12.0%** |
:::
...
なお、**肥料は来なくなっても、農産物や飼料は来ます**。米国などは肥料を国内優先しつつ、作物は高値で輸出するからです。日本が飢える心配はありません。だからこそ、短期の食料は輸入でつなぎながら、腰を据えて自然農法に転換できます。菌根菌ネットワークを育て直すには数年かかりますが、その猶予があります。
