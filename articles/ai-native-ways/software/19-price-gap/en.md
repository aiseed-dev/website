...
3-03 showed that the SIer commission model has reached the level
...
"lose on price" — **the market itself moved** (1-03). The same
...
- **Multi-tier subcontracting** — work flows from prime to tier-1,
  ...
  their cut (the structural details are covered in 3-07).
...
Restate the structural reasons from 3-03, in price terms.
