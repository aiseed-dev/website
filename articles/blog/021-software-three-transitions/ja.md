...
title: AI時代には「特化したエンジニアになれ」は構造を取り違えている
...
aiseed.dev が公開している [AI ネイティブな仕事の作法 ── ソフトウェア開発編](/ai-native-ways/software/)(論証を担う13章)が論証している構造変化は、次の三つの転換に集約できます。
...
詳しくは [1-04「ビルダーという役割」](/ai-native-ways/software/builder/)。
...
詳しくは [1-04「ビルダーの基盤はリベラルアーツ」節](/ai-native-ways/software/builder/)。
...
4. **経営判断を下す者は本質的に独立志向** ── 経営者・自営業者が自分の会社を構えるのは偶然ではない
...
詳しくは [3-08「雇用は AI 時代の農奴」節](/ai-native-ways/software/five-years/)。
...
第二次ルネサンスは「単なる AI 革命」では捕らえきれません。深い論証 ── **AI 革命は IT 革命の完成**(70年遅れの自動化約束の実現)、**LLM は超知能ではなく統計処理ツール**(AGI hype の構造的却下)、**アプリ作りは映画作りに似てくる**(ハリウッド〜YouTube の全幅で成立)、**AI 革命だけの話ではない**(化石資源・地政学・農業・金融・人口/医療/年金の同時並行転換)、**創造の時代と混乱の時代の両側**(トランプとナデラの判断集中という共通構造) ── は、[**ソフトウェア開発編 3-08「もう戻らない構造転換」**](/ai-native-ways/software/five-years/)で展開しています。
...
本記事は、aiseed.dev の **[AI ネイティブな仕事の作法 ── ソフトウェア開発編](/ai-native-ways/software/)**(論証を担う13章)を三対の語に圧縮したものです。各章で扱われている論証:

- [1-01: AI は、世界で最も難しいコーディング問題を解く](/ai-native-ways/software/coder-top/) ── Codeforces 2700 帯、月3万円で世界最上層
- [1-02: 保守フェーズの構造変化こそ本質](/ai-native-ways/software/maintenance-shift/) ── 保守の単位がコードから設計に移る
- [1-03: ソフトウェアエンジニアの仕事を AI がするようになる](/ai-native-ways/software/coder-end/) ── そろばん → 電卓と同じ構造
- [1-04: ビルダーという役割](/ai-native-ways/software/builder/) ── 決める・委譲する・評価する・統合する
- [1-05: 顧客が AI と協働して開発する時代](/ai-native-ways/software/customer-codev/) ── 9 割は顧客自身が作る
- [3-01: 企業は自分でコードを書かない ── 事務と基幹の並立](/ai-native-ways/software/two-worlds/) ── 二つの並立世界と二重の税、そしてその解消
- [3-02: デジタル主権 ── Microsoft 問題と Trump 問題](/ai-native-ways/software/sovereignty/) ── OSS とソブリン AI が経済でも安全保障でも有利に
- [3-03: SIer 委託モデルの構造的不経済](/ai-native-ways/software/sier-uneconomic/)
- [3-04: 価格競争力の桁違いの差](/ai-native-ways/software/price-gap/) ── 10〜100 倍は市場破壊
- [3-05: ロックイン問題](/ai-native-ways/software/lockin/) ── Palantir FDE を典型例として
- [3-06: 上級ビルダーは経営陣（CIO）](/ai-native-ways/software/hiring-builders/) ── 経営判断を下す側へ
- [3-07: 日本の SIer 業界の転換](/ai-native-ways/software/japan-transition/) ── 多重下請けは逆説的に転換を容易にする
- [3-08: もう戻らない構造転換](/ai-native-ways/software/five-years/) ── 不可逆性、第二次ルネサンス
