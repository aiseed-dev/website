                ...
                content=ft.Container(
                    content=ft.Column(
                        [
                            ...
                            _bullet(
                                "1. 今インストールされているアプリを検出して、Debian で動く代替を提案"
                            ),
                            _bullet(
                                "2. CPU・メモリ・ディスク・GPU を見て、Debian が動きそうか判定"
                            ),
                            _bullet(
                                "3. USB インストーラ作成の手順を、あなたの OS に合わせて案内"
                            ),
                            _bullet(
                                "4. つまずいたら「Claude 用プロンプトをコピー」ボタンで claude.ai に貼って相談"
                            ),
                        ],
                        spacing=8,
                    ),
