...
相手にする保守そのものが、要らなくなる**。やりたいことを、ふだんの言葉
で AI に伝えればいい ──「ここをこう変えたい」「この不具合を直して」。
あとは AI が、文脈をたどってコードを直し、テストもドキュメントも合わせて
作り直す。SIer に「ここを直して」と頼んでいたのと、同じことだ。これは
保守の話だが、新しく作る開発も同じ ── どちらも、**AI と対話して形にする
作業**になる。

保守の **主戦場** は、コードから設計・仕様・文脈へ移る。「触れない」が
