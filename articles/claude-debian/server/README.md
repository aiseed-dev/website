...
サブシリーズ**内**で閉じる。01 章は `prev_slug:` 空、最終章(10 章)は
...
| 07 | `07-containers` | 第7章 コンテナという選択 |
| 08 | `08-publishing` | 第8章 外の世界に公開する |
| 09 | `09-backup` | 第9章 データを守る |
| 10 | `10-operations` | 第10章 サーバーを育てる |
