...
導入編 第5章で、顧客自身がビルダーをやれることを示した。第3章で、AI
...
- IT の実装には **大量のコーダーが要り**、社内で全員抱えるのは規模
  ...
  初めて、案件規模に見合う人月が確保できた (構造の詳細は第5章で扱う)
...
プログラミング言語の習熟ではなく **リベラルアーツ**(導入編 第4章)で
...
安く・速く** なる。これは第2章の 10倍〜100倍の価格差の、コーポレート
サイト案件版だ。
...
導入編 第3章で「コーダーから判断側に移れる人」と「移れない人」が分かれる
...
導入編 第3章で「判断側に移れる人と移れない人で分かれる」と書いた。それは
...
第5章で見た「業界外の労働需要 (製造業、農業、AI 物理インフラ)」
...
- [第3章: ロックイン問題](/ai-native-ways/software/lockin/)
