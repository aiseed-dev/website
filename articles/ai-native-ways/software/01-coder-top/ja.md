...
自動運転、ロボットなど) には拡張できない (この境界線は転換編 第6章で扱う)。
...
最も高い帯まで押し上げた極端版だ(構造は転換編 第3章で詳述)。
...
- 転換編 第1章 ── SIer の委託モデルは、**閾値の上にいる AI** と競争できるか
- 転換編 第2章 ── 価格構造が違う相手と競争すると、どれだけの差になるか
- 転換編 第3章 ── 既存の委託関係は、どこで**ロックイン**として機能するか
- 転換編 第4章〜転換編 第6章 ── ビルダーの雇用、SIer 業界の転換、転換が完了する
  時間軸
...
- [転換編 第6章: 数年で完了する構造転換](/ai-native-ways/software/five-years/)
