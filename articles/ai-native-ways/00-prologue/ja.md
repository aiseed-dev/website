...
差し替えていく ── ユーザーが逃げられないことを見越して。**買い手が
依存を作った後で、その知能の中身を一方的に入れ替えられる**。判断を
手放すなという話の手前に、そもそも **手放した先の知能が、いつ・どんな
品質のものに差し替わるか分からない** という問題がある。これが
「ベンダー集中の AI」のもう一つの顔だ(→ [Microsoft 365 同等環境を
自前で作る](/blog/self-hosting-microsoft-365/))。
...
専門家しか読めない」という壁を崩す。ここで **オープンソースと
プロプライエタリの価値が逆転する** ── 閉じた製品の優位(磨かれていて
すぐ使える、手厚いサポート)は AI が肩代わりして薄まり、**開かれていて
自分で読み・直し・育てられること**が、初めて実利になる。一度コモンズに
出た資産は、もう誰にも回収できない。
