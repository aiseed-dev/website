...
next_slug: fabrication-and-materials
next_title: "The Democratization of Fabrication — Demand Moves to Materials, Value Moves to Judgment"
cta_label: Build
cta_title: Becoming a builder is not, structurally, "fleeing." It is forming a new class.
cta_text: Just as the merchants and craftsmen of the late medieval period built the free cities, the builders of the AI era build a new economy as free citizens.
cta_btn1_text: "Next: The Democratization of Fabrication"
cta_btn1_link: /en/insights/fabrication-and-materials/
cta_btn2_text: "Previous: translation-labor"
cta_btn2_link: /en/insights/translation-labor/
---
...
And this free city was not built overnight in the AI era. It is **the open
accumulation that the IT decades grew outside the feudal walls** (the closing
of [Part 1, Chapter 10](/en/insights/it-revolution-feudalism/)). Of what the
preparatory stage left behind, only this open side could become the next
era's substrate ([Part 2, Chapter 4](/en/insights/two-layer-ai-revolution/)).
