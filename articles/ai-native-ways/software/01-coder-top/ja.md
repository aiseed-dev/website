...
- 3-02 ── SIer の委託モデルは、**閾値の上にいる AI** と競争できるか
- 3-03 ── 価格構造が違う相手と競争すると、どれだけの差になるか
- 3-04 ── 既存の委託関係は、どこで**ロックイン**として機能するか
- 3-05〜3-07 ── ビルダーの雇用、SIer 業界の転換、転換が完了する
  時間軸
...
- [3-07: 数年で完了する構造転換](/ai-native-ways/software/five-years/)
