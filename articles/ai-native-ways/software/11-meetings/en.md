...
description: Video meetings with Jitsi, booking with Cal.com, classes and webinars with BigBlueButton. Replace Teams, Zoom, Calendly, and Microsoft Bookings with your own domain on your own server. Booking rides on the PostgreSQL from Chapter 6 and sends confirmations through the Chapter 10 mail. Step off per-seat, per-minute billing and keep meeting links and records on your own side.
date: 2026.07.11
label: Software 11
...
education, the tool for the "courses" mentioned back in Chapter 6.
...
Microsoft Bookings, with data on the **PostgreSQL from Chapter 6.**

```yaml
# compose.yaml — stand up booking on the Chapter 6 DB
services:
  booking:
...
When a booking lands, the **Chapter 10 mail** sends a confirmation and a
...
- **Cal.com** — in place of Calendly and Bookings (on the Chapter 6 PostgreSQL)
- **Integration** — booking → confirmation via Chapter 10 mail, Jitsi link auto-attached
