...
しかも、Microsoftは Copilot+ PC という新しいカテゴリを作り、NPU 40 TOPS という新しい足切りラインを設けている。Copilot+ PC だと20万円を超える価格になっている。しかも、高額なCopilot+ PCを購入しても、何年保証されるかもわからず、Linuxを直にインストールできるかどうかもわからない。
