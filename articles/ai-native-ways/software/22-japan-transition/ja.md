...
第4章で、IT 外注の本来の駆動力が「大量のコーダー人月の確保」だった
...
- **元請けに移る** ── 元請けは判断側に立てる人材 (= ビルダー候補)
  ...
  される可能性がある
- **顧客企業に移る** ── 第4章で見た「社内ビルダー」として、これ
  まで SIer に発注していた顧客企業に直接雇用される
- **独立して個人事業主・小規模法人** ── ビルダーとして直接顧客と
  契約する。第4章で見た弁護士・医師型の専門職モデル
- **別業界に移る** ── ソフトウェア開発を離れる選択肢もある (導入編 第3章
...
導入編 第3章で見た歴史的並行 ── 計算手や組版工が別領域に移った転換 ──
...
アーツ**(導入編 第4章)── 論理・言語化・倫理・体系的思考・歴史 ── に
...
- [第1章: SIer委託モデルの構造的不経済](/ai-native-ways/software/sier-uneconomic/)
