...
これは単なるコスト削減ではなく、**ソフトウェア開発の構造そのものが組み替わる**話だ。SIer 委託モデルが数年で完了する不可逆な転換と、それに代わって立つ「ビルダー」(判断中心の専門職、弁護士・医師と同位)の輪郭は、[AIネイティブな仕事の作法 ソフトウェア開発編](/ai-native-ways/software/)で 11 章にわたって展開している。
