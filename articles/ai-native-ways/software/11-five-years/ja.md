...
4. **判断中心の専門職は本質的に独立志向** ── 弁護士・医師・会計士
   が個人事務所やパートナーシップを好むのは偶然ではない(第9章)
...
(第6章)、顧客が自分で作る(第5章)、判断中心のビルダー(第4・9章)、
...
第9章で扱った「**工作派・現場技術者が組み込みに入る**」は、
この中間層への新規参入そのものだった。第10章で見た「**物が不足
...
| 自由都市・ギルド | フィレンツェ、ヴェネツィア、職人組合 | AI 時代の自由人、専門職組合(第9章) |
...
| 規模 | 映像制作 | AI 時代のアプリ作り |
|---|---|---|
| 大作 | ハリウッド大作 | OS・大規模インフラ・基幹業務システム ── 上級ビルダー(第9章) |
| 中規模 | テレビドラマ・劇場映画 | 業界共通システム・SaaS・専門アプリ ── ビルダー1〜数人 |
| 個人 | YouTube・TikTok | 個人の日々のツール ── 利用者本人が監督を兼ねる |

**大作の側** は上級ビルダーへの集約 ── 判断中心の専門職が引き続き
必要だ。**個人の側** はそもそも専門職が要らなくなる ── 利用者が
直接アプリの作者になる。最も激しく縮小するのは **中間層** で、
これは SIer 業界が担ってきた領域そのものだ(第6章・第7章)。

これが本サブシリーズが論じてきた構造変化の、最も正確な定式
である ── ソフトウェアエンジニアは中間層を中心に大幅縮小し、
**大作側ではビルダー(AI 時代の監督業) として残る**、**個人側では
利用者本人に統合される**。
