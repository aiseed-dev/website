...
第5章で、顧客自身がビルダーをやれることを示した。第16章で、AI
...
- IT の実装には **大量のコーダーが要り**、社内で全員抱えるのは規模
  ...
  初めて、案件規模に見合う人月が確保できた (構造の詳細は第18章で扱う)
...
安く・速く** なる。これは第15章の 10倍〜100倍の価格差の、コーポレート
サイト案件版だ。
...
第18章で見た「業界外の労働需要 (製造業、農業、AI 物理インフラ)」
...
- [第16章: ロックイン問題](/ai-native-ways/software/lockin/)
