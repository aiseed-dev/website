...
二つの問いを突きつける ── **個人としては、「コードを書くこと自体を
仕事の中心に置く役割(コーダー)」はどうなるのか**。**組織としては、
開発を請け負ってきた SIer は、まだ要るのか**。次の章では前者 ──
