...
| オフィス | Microsoft 365 | **Markdown + CSV + Python に切替**で大半は不要に。提出書類に Office 形式が必要な時は LibreOffice / Office オンラインで足りることが多い |
...
Microsoft の世界の中でしか動けない。**自分の作業領域を Markdown と
CSV と Python に作り直す**と、そもそも Office 系ソフトが要らない用途が
ほとんどになる。
...
具体的なコード・実測値は[AIネイティブな仕事の作法](/ai-native-ways/)
