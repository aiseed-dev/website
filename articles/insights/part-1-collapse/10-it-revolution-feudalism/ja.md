...
cta_btn1_text: 次へ 封建制が生んだ現代の矛盾——フェイク、注意搾取、Mythos、物質的盲点
cta_btn1_link: /insights/structural-contradictions/
cta_btn2_text: 前へ 巨大な権力は悲劇を生む
cta_btn2_link: /insights/cases/
---
...
この構文には、先例がある。[第一部 第3章](/insights/agriculture/)で見た
「緑の革命」だ。飢餓からの解放を掲げ、収量は実際に増えた ── だが構造と
しては、地力と自家採種という農家の手元の生産手段が、外部の供給網に
置き換わった。IT革命も同じ向きに動いた。情報の民主化を掲げ、便利さは
実際に増えた ── だが構造としては、**計算と情報という生産手段が、個人の
手元(ローカルの計算機、自前のファイル、読める書式)からプラットフォーム
の側へ移った**。革命の名を掲げた変化が、自立の手段を外へ移す ── 移動の
向きだけ見れば、二つの「革命」は同じ側に分類される。

## 翻訳労働 → 封建制 という因果鎖

[第二部 第6章](/insights/translation-labor/)で詳述する翻訳労働需要は、社会構造の階層を生む：
