...
だが、問いの向きが逆だ。守るべき砦を数えるのではない。**AI に何が
できるか** を、よろこんで数えればいい。

- **コードを書く** ── Python も SQL も HTML も
- **経理を回す** ── 請求書、仕訳、月次レポート
- **法務の下書き** ── 契約書、リスク洗い出し、判例参照
- **文章を書く** ── ブログ、メール、報告書、多言語化
- **データを分析する** ── 集計、可視化、傾向の抽出
- **デザインの下書き** ── 図、スライド、画面
- **調べて、要約して、整える** ── 一次情報の収集から構造化まで

かつて「専門職」と呼ばれた実務 ── 法律も医療も会計も、その**知識は
本から学べる**。職人の手仕事のような修業ではない。だから、同じテキ
ストから学んだ AI が、その**知識の参照や下書きを担える**。

ただし、これは専門職を軽んじる話ではない ── そこは深く尊重しなけ
ればならない。弁護士・医師・会計士の本当の値打ちは、知識を覚えて
いること自体ではなく、それを**目の前の一件にどう当てるかの判断**と、
**結果に負う責任**にある。だから、渡せるのは **作業** であって、判断と
責任ではない。AI にできる作業は、ためらわず渡せばいい ── そのぶん、
専門職も人も、本来の値打ちに集中できる。

なぜなら、**AI ができることが増えるほど、人間は上に上がる** からだ。
処理から判断へ。実務から方向づけへ。手を動かす人から、**何をするか
を決める人** へ ── 実務をこなす側ではなく、判断を下す側へ。個人が、
自分の仕事の経営者になる。

残るのではない。**解き放たれて、ここに上がる**:
...
これらは「最後に残った砦」ではない。**AI に実務を渡したからこそ手が
空き、初めて本気で取り組める仕事** だ。そして、これらは **面白い**。
退屈な処理仕事ではなく、本来の仕事だ。
