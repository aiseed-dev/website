...
別の面から見ていく ── SIer 委託の不経済(3-02)、桁違いの価格差
(3-03)、ロックインの正体(3-04)、ビルダーの直接雇用(3-05)、
日本固有の転換(3-06)、数年での完了(3-07)。**どれも、同じ一つの
崩壊を、別の角度から照らした像**だ。
...
AI による前提の反転。次に問うのは、その帰結の一つ目だ。**SIer 委託
モデルは、なぜ構造的に不経済になるのか**。

外注のために顧客が払う見えない手間を可視化すると、「同じ手間で
自分で作れる」が見えてくる。次の章では、それを工程に分解して見ていく。
