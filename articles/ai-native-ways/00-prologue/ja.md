...
考えは捨てる ── 型安全は Python でも `mypy` / Pydantic で得られる
時代だ。何より、**Java や C# は構造型データ(JSON / YAML / SQLite
/ Parquet)を素直に扱うのが難しい** ── パッケージ生態系の厚みが
Python と桁違いだ。AI ネイティブな時代において、**Java や C# は
もう過去の言語**。
