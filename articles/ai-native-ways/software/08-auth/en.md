...
Joining was described above. Leaving is simpler still — **stop the account at
the gate, and the person is out of everything.** Documents, mail, meetings,
...
layer at once" — flips, when the key is in your own hands, into **the
reliability of offboarding.**
