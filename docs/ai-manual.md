...
Claude も ChatGPT も Gemini も、いずれも「書記」として優秀ですが、**学習したデータと訓練の方針で性格が違います**。料理人にもそれぞれ得意な料理があるのと同じです。

| AI | 提供元 | 性格・強み |
|---|---|---|
| **Claude** | Anthropic | 慎重で思慮深く、長文の資料を扱うのが特に得意。コーディングが業界最高水準。「知らない」と言える誠実さがあり、ハルシネーション（5番）が比較的少ない。倫理的な設計（Constitutional AI）で、判断を委ねず「書記」の立場を守りやすい |
| **ChatGPT** | OpenAI | 流暢で親しみやすく、応答が速い。画像生成（DALL-E）や音声会話など多機能。最も認知度が高く、世界中で使われている |
| **Gemini** | Google | Gmail・Google ドライブ・カレンダーと連携でき、Google 検索とも統合。動画や画像の処理に強い。Google サービスをすでに使っている人と相性がいい |

最初は **一つだけ** 契約して、自分の仕事で試してみてください。複数契約しても月数千〜1万円程度ですが、まずは一つに慣れる方が早道です。

本マニュアルは **Claude** を念頭に書いていますが、**6つのコツは三つともに同じように当てはまります**。半年単位で勢力図が変わる業界なので、**最終的には自分で試して相性を確かめる** のが一番です。書記との相性は人間同士と同じく、使ってみないと分からない部分があります。

ローカル AI（自分のパソコンで動く、Microsoft・OpenAI・Google などのクラウドを使わない AI）については、4番で扱います。
