...
Here the asymmetry of licensing starts to bite. The perpetual Office Home & Business 2024 does come with commercial-use rights, but it is a standalone desktop edition with **no network features for collaborative editing**. If you want several people editing at once, you end up needing a Microsoft 365 Business subscription after all — and that is **one license, per person**, with **the charge stacking up for every collaborator you add**. For a company that can carry a seat per employee as an expense, it still works. But for a "mere group" — a neighborhood association, a PTA, an NPO, a club, a study circle, volunteers, a family — **the per-seat cost means giving up on collaborative editing altogether**. With ONLYOFFICE DocSpace Community you just invite everyone to your own server — **no per-head charge** (and ONLYOFFICE Docs 9.4, in May 2026, removed the simultaneous-connection limit as well). It is precisely the people collaborating freely outside a company for whom this works.
