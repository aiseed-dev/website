...
だが AI の能力はそこで止まらない。**設計**、システム全体の構造を自分で
組み立てる力にも、すでに入っている。

その傍証が、思わぬところから出た。Fable / Mythos の世代では、攻撃者が
Claude を悪用し、**AI が標的への攻撃工程の大半を自律的に遂行した**事例
が公表されている(2025 年、Anthropic が自動サイバー諜報キャンペーンと
して報告)。攻撃を自分で進めるには、相手のシステムを偵察し、弱点を読み、
攻め筋の構造を組み立てる力が要る ── コードを書く力ではなく、**設計する
力**だ。攻撃に使えるなら、設計にも使える。

要するに、**コーディングも設計も、AI が上級エンジニアを超えはじめた**。
2700 帯は世界に数十人の最上層 ── 並の上級エンジニアはとうに超えている。
設計も、攻撃の構造まで自律で組み立てる水準に達した。二つが揃えば、結論
は一つだ ── **Mythos/Fable 時代になって、AI は最強の SIer になった**。
