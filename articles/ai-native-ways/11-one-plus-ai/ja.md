...
これは個人の自立だ。**組織が変わるのを待たない**。自立編 第5章の事務処理、
自立編 第9章の業務システムも、すべてこの「内側から溶かす」作法を扱った。
...
- [自立編 第5章: 文書を取り戻す ── OnlyOffice Docs を PocketBase に組み込む](/ai-native-ways/software/documents/)
