...
第4章で、ビルダーは社内の人間である必要がないと見た。AI と対話して
...
- **第6章** ── Excel マクロ(VBA)を Python に移す
- **第7章** ── Web サイトを、AI と対話して作る
- **第8章** ── 組み込みを作る
...
定常業務を丸投げしないのと同じだ(転換編 第4章)。多年契約の SIer 委託は、
もう要らない。
...
次章から三つ、その実例を扱う ── Excel マクロを Python に(第6章)、Web
サイトを(第7章)、組み込みを(第8章)。
