...
2026年5月時点で、Microsoft が公式に保証している Windows 11 Home/Proのsサポート期限は、2027年10月12日(25H2 のサポート終了日)。今日から1年5ヶ月先である。

それ以降、Windows がどうなるかは、Microsoft 自身も発表していない。Windows 12 のロードマップはない。今 PC を買っても、5年後に動く保証はない。
...
Windows は今、4つの構造的な理由で壊れていっている。1つは Windows という製品が30年かけて抱え込んだ過去の重みで、残り3つはナデラ時代に意思決定された問題だ。それを止められる組織能力はもう持っていない。
...
ナデラは、Windows を「買って長期間固定で使うOS」から「継続更新を前提としたサービス型OS」に変化させた。もはや**搾り取るべき資産**である。
