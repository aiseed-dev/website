# アメリカのAI覇権の終わりの始まり — 最高裁判決と米国依存の構造的リスク5層
...
- 2026年、Entra IDにAIエージェント用のID体系(Agent ID)が導入され、AIエージェントが認証基盤上の主体として扱われるようになった。
...
米国の技術・サービスを使わないという話ではない。使い続けるとしても、それが止まったとき・法的根拠を失ったときに自組織が存続できる構造を先に作っておく、ということである。
