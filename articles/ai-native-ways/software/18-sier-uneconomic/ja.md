...
もし Microsoft の有能な AI 研究者が開発の中心にいれば、ゴミだらけの
GitHub をそのまま学習させはしなかった。**優良なコードを選んで学習させた
はずだ**。学習データの質が出力を決めるのは、研究者なら誰でも知っている。
そうならなかったこと自体が、**判断の中心に有能な作り手がいなかった**こと
を示している。Microsoft には有能な AI 研究者がいた。にもかかわらず、
彼らを責任者にせず、開発を OpenAI に委ねた ── **自社の有能な AI 研究者
を責任者にしなかったこと、これがナデラの過失だ**。
