...
第2章で、保守も開発も AI と対話する作業に変わることを見た。本章は
...
元請け下請け構造は、すべてこの前提の上に建っている(転換編 第1章で扱う)。

## AI が、コーダーにもソフトウェアエンジニアにもなる

第1章で、AI が最強の SIer になった ── コードを書き、文脈を理解して
