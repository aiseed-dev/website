...
- **SIer 委託モデルが構造的に不経済** (第14章) ── 同じ手間で自分で
  作れる
- **価格差が桁違い** (第15章) ── 10倍〜100倍、競争ではなく市場破壊
- **ロックインが解消する** (第16章) ── AI ネイティブな標準コード、
  Palantir FDE の対極
- **各社がビルダーを雇用する** (第17章) ── 弁護士・医師と同位置の
  専門職。供給源は元コーダーだけでなく、AI + Python + Flet で
  参入する **VB/VBA 世代・工作派・現場技術者・学生** にも広がる
- **多重下請けが転換を緩衝する** (第18章) ── 雇用調整なしに縮小可能
...
flowchart LR
  ...
  Coder["コーダー消滅<br/>(第3章)"]
  Builder["ビルダー需要<br/>(第4・17章)"]
  Customer["顧客自製<br/>(第5章)"]
  SIer["SIer 縮小<br/>(第14・15章)"]
  Lock["ロックイン解消<br/>(第16章)"]
  Industry["業界転換<br/>(第18章)"]
...
── 動くが平凡なコードが膨大に生まれ、保守は崩壊する(第2章の vibe
...
- 第18章に **「ソフトウェアより物が不足する時代」** セクションを追加
...
- **既存契約の満了サイクル** ── SIer の長期保守契約は典型的に
  3〜5 年。次の更新タイミングで置き換え評価される(第16章)
...
- SIer が一度多重下請けを縮小すると、また下請けを大量採用しない
  (第18章) ── 縮小した契約関係は再構築されない
- ビルダーが専門職として認知されると、その役割定義は持続する
  (第17章) ── 弁護士・医師の位置に動いたものは戻らない
...
| 教養 | リベラルアーツ(自由七科) | リベラルアーツの現代版 ── 判断・言語化・論理・体系的思考・倫理(第4章) |
...
2. **1 人 + AI = 10 人チーム**(第4章)── 集中化のメリットが消える
3. **判断と実行の境界が一人の中で閉じる**(第4章)── 集約・調整・
   管理の overhead が純粋な無駄になる
4. **判断中心の専門職は本質的に独立志向** ── 弁護士・医師・会計士
   が個人事務所やパートナーシップを好むのは偶然ではない(第17章)
...
(第14章)、顧客が自分で作る(第5章)、判断中心のビルダー(第4・17章)、
...
第17章で扱った「**工作派・現場技術者が組み込みに入る**」は、
この中間層への新規参入そのものだった。第18章で見た「**物が不足
...
|---|---|---|
| 復活する古典 | ギリシャ・ローマの古典学 | リベラルアーツ(第4章) |
| ポリマス(万能人)の理想 | レオナルド・ダ・ヴィンチ | ビルダー、1 人 + AI(第4章) |
| 個人の主観性 | 人文主義の「私」 | 自分の道具・自分のデータ・自分の判断 |
| 俗語の解放 | ダンテのイタリア語、ルターのドイツ語 | 自然言語が「プログラミング言語」になる |
| 自由都市・ギルド | フィレンツェ、ヴェネツィア、職人組合 | AI 時代の自由人、専門職組合(第17章) |
...
動く**(第18章)。AI データセンター建設、製造業の復活、自然農法
