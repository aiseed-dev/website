...
証明だ。だが、**設計はコーディングとは別の能力**だ。速く正しく書ける
ことは、システム全体の構造を自分で決められることを意味しない。だから、
設計能力には別の証拠が要る。
...
攻め筋の構造を組み立てる力が要る ── コードを書く力ではなく、**システム
を設計する力**だ。攻撃に使えるなら、設計にも使える。

つまり AI は、**二つの別々の能力**で最上層に達した ── コードを書く力
(2700 帯)と、システムを設計する力(自律攻撃)。**コーディングも設計も、
AI が上級エンジニアを超えはじめた**。二つが揃えば、結論は一つだ ──
**Mythos/Fable 時代になって、AI は最強の SIer になった**。要件を読み、
構造を決め、実装し、動かす SIer の仕事の全体を、一人でこなす。しかも、
世界に数十人の希少資源ではなく、月 3 万円で誰でも呼べる。
