...
title: ITという産業が終わり、素材と組立の時代が始まる
subtitle: 消えるのは仕事ではなく「産業であること」 ── ソフトの障壁が消えた世界で、障壁として残るのは物理だけである
date: 2026.07.25
description: これまでの四本で、AI の経済の期限と地政学の期限を書いた。どちらも「集中の時代の終わり」の断面だった。五本目は、終わった後に何が育つかを書く。製品はソフトと部品と素材と組立でできていて、前の二つがゼロに向かえば、残るのは素材と組立だけになる。IT の仕事量は消えない。消えるのは、IT が独立した産業として売買される状態である ── 先例は電化を売る産業で、電化が完了したときにそれは消え、各工場の内部機能になった。引き金は AI が検証をほぼ無料にしたことだ。情報の非対称の上に立っていた商売は、非対称が消えれば立てない。そして素材と組立が勝つ理由は三つ ── 残余の論理、需要の効果、そして複製できない参入障壁の物理性。この転換は日本と地方に有利に働く。日本製造業の敗因は品質ではなく、ソフトが作れないこととコストだったからだ。本連載(五部作)の五本目。
lang: ja
label: Blog
category: 構造分析ノート
---
...
これまでの四本で、AIの経済の期限([K3の重み公開](https://aiseed.dev/blog/kimi-k3-what-to-watch/)、[AI企業の財務](https://aiseed.dev/blog/ai-companies-reality/)、[Microsoftの決算](https://aiseed.dev/blog/microsoft-earnings-verdict/))と、[地政学の期限(ウクライナ、イラン、中国)](https://aiseed.dev/blog/three-fronts-same-week/)を書いた。どちらも「集中の時代の終わり」の断面だった。五本目は、終わった後に何が育つかを書く。結論を先に言う。IT産業は縮小していく。そして、ソフトウェアと部品の価格が下がったことで、素材産業と、組み立てる製造業が有利になる。
...
- ブログ [7月29日、Microsoft の決算で見るべきもの](https://aiseed.dev/blog/microsoft-earnings-verdict/) ── 三本目。本稿と共通の試験紙(Sonnetクラスの箱落ち)を特定した回
- ブログ [同じ週に、三つの決着が近づいている](https://aiseed.dev/blog/three-fronts-same-week/) ── 四本目。AIの外側で同じ夏に来ている三つの期限
- ブログ [ソフトウェアの三つの転換](https://aiseed.dev/blog/software-three-transitions/) ── 本稿の前提となる構造の見取り図
- ブログ [社内業務システムは、もう外注するものではない](https://aiseed.dev/blog/in-house-business-systems/) ── 「システムは買う商品から作る内部機能に戻る」の実務版
- ブログ [Fable 5 が戻ってきたら、すぐやるべきこと ── 稼働中システムを、全部検証する](https://aiseed.dev/blog/verification-shock/) ── 「検証が無料になる」の組織版
