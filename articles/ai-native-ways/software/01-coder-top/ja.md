...
自動運転、ロボットなど) には拡張できない (この境界線は3-06で扱う)。
...
(2700 帯)と、文脈を理解して構造を決める力=設計(自律攻撃)。**コーディング
も設計も、AI が上級エンジニアを超えはじめた**。二つが揃えば、結論は一つ
...
> できる」証明 ── コーディングも設計も上級エンジニアを超え、**AI は
> 最強の SIer になった**。
...
- 3-01 ── SIer の委託モデルは、**閾値の上にいる AI** と競争できるか
- 3-02 ── 価格構造が違う相手と競争すると、どれだけの差になるか
- 3-03 ── 既存の委託関係は、どこで**ロックイン**として機能するか
- 3-04〜3-06 ── ビルダーの雇用、SIer 業界の転換、転換が完了する
  時間軸
...
- [3-06: 数年で完了する構造転換](/ai-native-ways/software/five-years/)
