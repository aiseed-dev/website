...
As a result, Copilot output gets stuffed into Excel cells and format conversion runs every time. **The structure cannot ride the AI revolution.** This is another manifestation of the same structural problem as ["Microsoft's Collapse" in Part 1, Chapter 6](/en/insights/microsoft/).
...
revolution is, in other words, **the open accumulation that the IT decades
grew alongside their closed product lines.** As movable-type printing had its
...
Copilot's inability to ride is no accident. **A closed format cannot be the
substrate of a revolution.**
