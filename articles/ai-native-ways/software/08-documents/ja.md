...
description: Word・Excel・PowerPoint は、人が書き人が読む入出力の道具だ。Nextcloud のような別の保管アプリは足さず、第7章で立てた PocketBase をそのまま文書の置き場(保管・認証・共有)にして、OnlyOffice Docs を編集エンジンだけ組み込む ── 独自の、薄い文書アプリ。docx・xlsx・pptx を高互換で開き、同時編集し、門番の内側に最初から入る。形式は変えず、主導権だけ取り戻す。
date: 2026.07.04
label: Software 08
