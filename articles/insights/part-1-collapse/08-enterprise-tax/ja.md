...
cta_btn2_link: /insights/nvidia/
cta_btn2_text: 前へ NVIDIAの崩壊
cta_btn1_link: /insights/cases/
cta_btn1_text: 次へ 巨大な権力は悲劇を生む
...
これは単なるコスト削減ではなく、**ソフトウェア開発の構造そのものが組み替わる**話だ。SIer 委託モデルが数年で完了する不可逆な転換と、それに代わって立つ「ビルダー」(経営判断を下す経営陣＝CIO)の輪郭は、[AIネイティブな仕事の作法 ソフトウェア開発編](/ai-native-ways/software/)の論証を担う11章で展開している。
