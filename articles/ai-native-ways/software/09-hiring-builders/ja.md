...
並列はもう一歩深いところまで通る。弁護士・医師・会計士の専門教育
の中身は、技法の前に **リベラルアーツ**(論理・修辞・倫理・体系
的思考・歴史)に置かれている。これらの判断は技法だけでは下せない
からだ。ビルダーも同じ位置にいる以上、その採用と育成の基盤は、
プログラミング言語の習熟ではなく **リベラルアーツ**(第4章)で
あるべきだ。**「コードを書ける人」ではなく「判断できる人」を
採用する** ── これが、各社のビルダー採用が本来向かうべき軸線
である。
