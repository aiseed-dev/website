...
def _render_markdown() -> str:
    ...
    lines += [
        "",
        "## インストール直後に予期しておくべきトラブル (第 8 章)",
        "",
        "起動直後、ほぼ必ず 2〜3 個は何か動かない。一つずつ分解して潰す:",
        "",
        "1. **ディスプレイ** ── 解像度・スケーリング・外部モニター",
        "2. **Wi-Fi** ── 繋がらない / 速度",
        "3. **Bluetooth** ── マウス・キーボード・イヤホン",
        "4. **サウンド** ── 内蔵スピーカー / マイク",
        "5. **サスペンド / 復帰** ── 蓋を閉じて開く挙動",
        "6. **日本語入力** ── Fcitx5 + Mozc (詳細は第 10 章)",
        "7. **周辺機器** ── プリンタ・ウェブカメラ・USB 機器",
        "",
        "**Debian 起動後、最初に走らせる診断コマンド:**",
        "",
        "```bash",
        "journalctl -b -p err          # 今回起動以降のエラー",
        "lspci -nnk                    # PCI デバイス + ドライバ",
        "lsusb                         # USB デバイス",
        "dmesg | tail -50              # カーネルメッセージ",
        ...
        "3. Debian が立ち上がったら、まず上の 5 コマンドを走らせて出力を保存。",
        "4. 第 8 章 (https://aiseed.dev/claude-debian/08-first-troubleshooting/)",
        "   の統一テンプレートで Claude に相談。",
        "5. 続けて 第 9 章 (デスクトップ)、第 10 章 (日本語入力)、",
        "   第 11 章 (アプリ選択) に進む。",
        "",
        "---",
